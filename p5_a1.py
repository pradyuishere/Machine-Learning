...
sigma=std
alpha=float(input("Enter the standard deviation of weights : "))
lagrangian_multiplier= (sigma*sigma)/(alpha*alpha)
print("The new lagrangian_multiplier is : ", lagrangian_multiplier)
...
y=y.T
#_______________________________________________________________________________
#Calculating the Lagrangian_identity
...
weights_matrix_calc_noise = weights_matrix_calc
#_______________________________________________________________________________
...
predicted_outputs_new=x_feature_new*weights_matrix_calc_noise
